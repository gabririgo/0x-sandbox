    ...
    public renderNetworkIndicator(): React.ReactNode {
        ...
        if (networkId) {
            ...
            if (networkName === Network.Unknown || networkName === Network.Mainnet) {
                return <Tag isColor="warning">{networkName} - Use at your own risk</Tag>;
            }
            ...
            <Navbar style={{ zIndex: -1 }}>
                <NavbarBrand>
                    <NavbarItem>
                        <Image
                            isSize="16x16"
                            src="https://rigoblock.com/assets/favicons/favicon.png"
                            style={{ marginLeft: 0, marginRight: 10 }}
                        />
                        <strong> RigoBlock Relay Sandbox </strong>
