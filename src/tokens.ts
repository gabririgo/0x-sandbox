export const TOKENS = {
    ...
    GRG: {
        name: 'RigoBlock Protocol Token',
        decimals: 18,
        symbol: 'GRG',
        isTradeable: true,
        isMintable: false,
        image: 'https://rigoblock.com/assets/favicons/favicon.png',
    },
    MKR: {
        name: 'Maker DAO',
        decimals: 18,
...
export const TOKENS_BY_NETWORK: { [networkId: number]: { [tokenSymbol: string]: Token } } = {
    ...
    3: {
        ...
        GRG: {
            ...TOKENS.GRG,
            address: '0x8DCde2ea008D0e831E80f00100712D4D8f41eB35',
        },
        MKR: {
            ...TOKENS.MKR,
    ...
    42: {
        ...
        GRG: {
            ...TOKENS.GRG,
            address: '0x230ad6ce17eb9143c7cc4ee07980f89b2c701f41',
        },
        MKR: {
            ...TOKENS.MKR,
